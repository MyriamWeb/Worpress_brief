			...
			<?php }else{ ?>
				...
				<div class="vw-bakery-pattern-page">
					...
					<p><b><?php esc_html_e('1. First you need to activate these plugins','vw-bakery'); ?></b></p>
	              	...
	              	<div class="vw-bakery-pattern-page">
				    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-templates&woo=true&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','vw-bakery'); ?></a>
				    	</div>
			    </div>
			<?php } ?>
		</div>
