  ...
  <div class="post-main-box">
    ...
    if($vw_bakery_theme_lay == 'Default'){ ?>
      <div class="row">
        ...
        <?php } ?>
        <div class="new-text <?php if(has_post_thumbnail()) { ?>col-lg-6 col-md-6"<?php } else { ?>col-md-12 col-lg-12 <?php } ?>">
          <h2 class="section-title"><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo the_title_attribute(); ?>"><?php the_title();?><span class="screen-reader-text"><?php the_title(); ?></span></a></h2>
          <?php if( get_theme_mod( 'vw_bakery_toggle_postdate',true) != '' || get_theme_mod( 'vw_bakery_toggle_author',true) != '' || get_theme_mod( 'vw_bakery_toggle_comments',true) != '' || get_theme_mod( 'vw_bakery_toggle_time',true) != '') { ?>
            <div class="post-info">
              ...
              <?php if(get_theme_mod('vw_bakery_toggle_comments',true)==1){ ?>
                <span>|</span> <i class="fa fa-comments" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'vw-bakery'), __('0 Comments', 'vw-bakery'), __('% Comments', 'vw-bakery') ); ?> </span>
              <?php } ?>
            ...
            <p>
              ...
              if($vw_bakery_theme_lay == 'Excerpt'){ ?>
                <?php if(get_the_excerpt()) { ?>
                  <p><?php $excerpt = get_the_excerpt(); echo esc_html( vw_bakery_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_bakery_excerpt_number','30')))); ?> <?php echo esc_html(get_theme_mod('vw_bakery_excerpt_suffix',''));?></p>
                <?php }?>
              <?php }?>
            </p>
          </div>
