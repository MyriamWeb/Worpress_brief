			...
			<?php }else{ ?>
				...
				<div class="cafe-coffee-shop-pattern-page">
					...
					<p><b><?php esc_html_e('1. First you need to activate these plugins','cafe-coffee-shop'); ?></b></p>
	              	...
	              	<div class="cafe-coffee-shop-pattern-page">
				    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-templates&woo=true&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','cafe-coffee-shop'); ?></a>
				    	</div>
			    </div>
			<?php } ?>
		</div>
